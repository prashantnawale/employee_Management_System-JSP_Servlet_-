...
/**
 * Servlet implementation class CSP_create_Login_Validation
 */
@WebServlet("/CSP_create_Login_Validation")
public class CSP_create_Login_Validation extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String confirmpassword=request.getParameter("confirmpassword");
         ...
         PreparedStatement ps = con.prepareStatement("insert into CSPlogin values(?,?,?,?,?)");   //  SELECT * from "+createAccount+" WHERE id=?");
          ...
          //int i=ps.executeUpdate();
           ...
           response.sendRedirect("CSP_Login.jsp");
           }
           else {
