 ...
 */
@WebServlet("/Agent_create_Login_Validation")
public class Agent_create_Login_Validation extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String confirmpassword=request.getParameter("confirmpassword");
         ...
         PreparedStatement ps = con.prepareStatement("insert into agentlogin values(?,?,?,?,?)");   //  SELECT * from "+createAccount+" WHERE id=?");
