...
/**
 * Servlet implementation class Create_New_Create_Login_Validation
 */
@WebServlet("/Create_New_Create_Login_Validation")
public class Create_New_Create_Login_Validation extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String confirmpassword=request.getParameter("confirmpassword");
         ...
         PreparedStatement ps = con.prepareStatement("insert into employee_login  values(?,?,?,?,?)");   //  SELECT * from "+createAccount+" WHERE id=?");
          ...
          //int i=ps.executeUpdate();
           ...
           response.sendRedirect("Employee_Login.jsp");
        	   ...
        	   response.sendRedirect("Create_New_Employee_Login_Account.jsp?msg=Password and ConfirmPassword Not Match");
           }
