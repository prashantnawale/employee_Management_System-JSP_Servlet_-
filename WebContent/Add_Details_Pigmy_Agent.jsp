...
<body style="color:black;">
	...
	<center>
		<h1 style="color: Black;">Add New Pigmy Agent Details </h1>
		</center>
		<div class="c">
	...
	<div class="">
		<h3>
			...
			<input type="text"
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="text" placeholder=other name="other"><br>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			Guarantor:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="text" placeholder=Guarantor_name name="guarantor">
				...
				Authentic :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="text" placeholder=Authentic_name name="authentic"><br>
			...
			Inheritor:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" placeholder=Inheritor_name name="inheritor">
			...
			Address Of Inheritor:
									<input type="text"
				placeholder=address_of_inheritor name="address_of_inheritor">
			...
			<input type="text" placeholder=address_of_inheritor name="relation_with_inheritor">
